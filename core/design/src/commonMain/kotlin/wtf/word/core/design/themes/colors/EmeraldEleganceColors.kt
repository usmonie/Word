...
object EmeraldEleganceColors: Colors() {
    override val light_primary: Color = Color(0xFF00695C)
    override val light_onPrimary: Color = Color(0xFFFFFFFF)
    override val light_primaryContainer: Color = Color(0xFF004D40)
    override val light_onPrimaryContainer: Color = Color(0xFFB2DFDB)
    ...
    override val light_inverseSurface: Color = Color(0xFFB2DFDB)
    override val light_inverseOnSurface: Color = Color(0xFF004D40)
    override val light_inversePrimary: Color = Color(0xFF80CBC4)
    override val light_surfaceTint: Color = light_primary
    override val light_outlineVariant: Color = Color(0xFFB2DFDB)
    ...
    override val dark_surface: Color = Color(0xFF003D33)
