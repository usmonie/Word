...
public val RocketLaunchOutline: ImageVector
    get() {
        if (_RocketLaunchOutline != null) {
            return _RocketLaunchOutline!!
        }
        _RocketLaunchOutline = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(19.22f, 4f)
                curveTo(19.5f, 4f, 19.75f, 4f, 19.96f, 4.05f)
                ...
                curveTo(15.18f, 4.58f, 17.64f, 4f, 19.22f, 4f)
                moveTo(19.22f, 2f)
                curveTo(17.24f, 2f, 14.24f, 2.69f, 11f, 5.93f)
                ...
                reflectiveCurveTo(20.7f, 2f, 19.22f, 2f)
                moveTo(14.54f, 9.46f)
