...
@Immutable
class AdMob(
    private val banner: @Composable (adKey: String, modifier: Modifier) -> Unit,
    private val rewardedInterstitial: @Composable (onAddDismissed: () -> Unit) -> Unit,
    private val startup: @Composable (adKey: String, modifier: Modifier) -> Unit,
