...
public val MyIconPack.Ru: ImageVector
    get() {
        if (_ru != null) {
            return _ru!!
        }
        _ru = Builder(name = "Ru", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp, viewportWidth
                = 900.0f, viewportHeight = 600.0f).apply {
            ...
            path(fill = SolidColor(Color(0xFF0083d6)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
