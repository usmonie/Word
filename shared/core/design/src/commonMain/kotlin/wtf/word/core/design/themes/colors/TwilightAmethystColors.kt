...
object TwilightAmethystColors : Colors() {
    ...
    override val light_surface = Color(0xfff8eef8)
    override val light_onSurface = Color(0xFF201A19)
    override val light_surfaceVariant = Color(0xFFeddfed)
    override val light_onSurfaceVariant = Color(0xFF201A19)
    ...
    override val light_surfaceContainer = Color(0xFFebd1eb)
    override val light_surfaceContainerHighest = Color(0xFFffe6ff)
