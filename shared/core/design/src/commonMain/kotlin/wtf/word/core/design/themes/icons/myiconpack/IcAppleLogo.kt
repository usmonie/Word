...
public val MyIconPack.IcAppleLogo: ImageVector
    get() {
        if (_icAppleLogo != null) {
            return _icAppleLogo!!
        }
        _icAppleLogo = Builder(name = "IcAppleLogo", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 50.0f, viewportHeight = 50.0f).apply {
