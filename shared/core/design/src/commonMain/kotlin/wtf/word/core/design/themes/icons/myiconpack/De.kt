...
public val MyIconPack.De: ImageVector
    get() {
        if (_de != null) {
            return _de!!
        }
        _de = Builder(name = "De", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp, viewportWidth
                = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFFffce00)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(fill = SolidColor(Color(0xFF000001)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(0.0f, 0.0f)
                horizontalLineToRelative(512.0f)
