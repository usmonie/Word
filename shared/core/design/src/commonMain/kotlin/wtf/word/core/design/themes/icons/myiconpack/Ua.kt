...
public val MyIconPack.Ua: ImageVector
    get() {
        if (_ua != null) {
            return _ua!!
        }
        _ua = Builder(name = "Ua", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp, viewportWidth
                = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFFffd700)), stroke = null, strokeLineWidth = 1.0f,
            ...
            path(fill = SolidColor(Color(0xFF0057b8)), stroke = null, strokeLineWidth = 1.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = EvenOdd) {
                moveTo(0.0f, 0.0f)
                horizontalLineToRelative(512.0f)
