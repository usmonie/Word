...
public val MyIconPack.Fr: ImageVector
    get() {
        if (_fr != null) {
            return _fr!!
        }
        _fr = Builder(name = "Fr", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFF000091)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(0.0f, 0.0f)
            ...
            path(fill = SolidColor(Color(0xFFe1000f)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(341.3f, 0.0f)
