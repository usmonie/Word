...
public val Flag.Es: ImageVector
    get() {
        if (_Es != null) {
            return _Es!!
        }
        _Es = Builder(
            name = "Es", defaultWidth = 750.0.dp,
            defaultHeight = 500.0.dp, viewportWidth = 750.0f, viewportHeight = 500.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFFc60b1e)), stroke = null, strokeLineWidth = 0.0f,
