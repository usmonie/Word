...
public val Flag.Pt: ImageVector
    get() {
        if (_pt != null) {
            return _pt!!
        }
        _pt = Builder(
            name = "Pt", defaultWidth = 128.0.dp, defaultHeight = 128.0.dp,
            viewportWidth =
            512.0f,
            ...
            path(
                ...
                strokeLineWidth = 0.7f, strokeLineCap = Round,
                strokeLineJoin =
            ...
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 0.6f, strokeLineCap = Round,
                strokeLineJoin =
                StrokeJoin.Companion.Round,
                strokeLineMiter = 4.0f, pathFillType = EvenOdd
            ) {
