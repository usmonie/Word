...
import com.usmonie.core.kit.composables.base.text.SuggestedFontSizesStatus.Companion.rememberSuggestedFontSizesStatus
 ...
 *
 * Features:
 *  1. Best performance: Utilizes a dichotomous binary search algorithm for
 *  swift and optimal text size determination without unnecessary iterations.
 ...
 * (Should be sorted from smallest to largest, not empty and contains only sp text unit).
 * @param suggestedFontSizesStatus Whether or not suggestedFontSizes is valid:
 * not empty - contains oly sp text unit - sorted.
 ...
 * this parameter is ignored if [suggestedFontSizes] is specified
 * and [suggestedFontSizesStatus] is [SuggestedFontSizesStatus.VALID].
 * @param minTextSize The minimum text size allowed. this parameter is ignored
 * if [suggestedFontSizes] is specified or [suggestedFontSizesStatus] is [SuggestedFontSizesStatus.VALID].
...
/**
 * Composable function that automatically adjusts the text size to fit
 * within given constraints using AnnotatedString, considering the ratio of line spacing to text size.
 *
 * Features:
