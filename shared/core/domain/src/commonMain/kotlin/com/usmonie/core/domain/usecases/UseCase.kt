package com.usmonie.core.domain.usecases
...
fun interface CoroutineUseCase<in Input, out Output> {
...
suspend operator fun <Output> FlowUseCase<Unit, Output>.invoke() = invoke(Unit)
