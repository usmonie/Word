...
import com.usmonie.word.features.dictionary.data.db.models.toDatabase
...
internal class WordsRepositoryImpl(private val realm: Realm, private val api: WordApi) : WordRepository {
